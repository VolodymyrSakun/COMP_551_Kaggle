...
imagesTrain = np.load('train_images32x32BW.npy', encoding='latin1')
imagesForecast = np.load('test_images32x32BW.npy', encoding='latin1')
...
# linear svc
print("Linear SVC")
classifierSVClinear = svm.SVC(C=1.0, kernel='linear', gamma=0.001,\
